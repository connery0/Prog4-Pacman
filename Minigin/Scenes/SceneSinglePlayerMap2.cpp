...
SceneSinglePlayerMap2::SceneSinglePlayerMap2(): Scene("SinglePlayerMap2")
{
	SceneSinglePlayerMap2::Initialize();
	isInitialized=true;
}


SceneSinglePlayerMap2::~SceneSinglePlayerMap2()
{
	backButton->Clear();
}

void SceneSinglePlayerMap2::Initialize()
{
	...
	//Extra Ghosts (always ai)
	{
		...
		newGhost2->CreateChildComponent<dae::TextureColliderComp>("Ghost.png");
...
void SceneSinglePlayerMap2::Update(float deltaTime)
{
